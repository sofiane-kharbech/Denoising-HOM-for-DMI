...
## Main scripts
* `GenDataset.m`: generates a set of HOS (i.e., HOM and HOC) to identify the modulation type. You can edit the transmitter, channel, and receiver parameters in this file.
